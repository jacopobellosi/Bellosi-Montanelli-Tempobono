...
\section{Purpose}
developers who must implement the requirements and can detailed description of BBP.
...
\begin{center}
    \begin{longtable}{ |l|p{0.8\linewidth}| }
        ...
        \hline
        WP\cwp      & A Registered User wants to add a path(manually or automatic).   \\
        \hline
