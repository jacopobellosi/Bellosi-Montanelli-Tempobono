...
\begin{center}
    \begin{longtable}{ |l|p{0.9\linewidth}| }
        ...
        \hline
        G\cg        &   To gather, aggregate, and provide users with actionable data regarding cycle path conditions (e.g., surface status, obstacles, potholes) to support route planning and inform maintenance entities.\\
        \hline
        ...
        \hline
        G\cg        &  To establish a community-based path evaluation system by (a) enabling registered users to submit publishable path information , and (b) implementing an automated merging logic that assesses data reliability based on freshness and confirmation consensus.\\
        \hline
        \caption{Goals table.}
        \label{tab:goals_tab}%
    \end{longtable}
...
The scope of the Best Bike Paths (BBP) system is to define a software platform, consisting of a mobile application and a backend system, designed to assist cyclists through intelligent route discovery, personal trip recording, and collaborative path evaluation . The system's primary scope is to enable both Anonymous and Registered Users to find, assess, and share cycling routes based on real, user-generated data and sensor-based observations .

Functionality within the scope includes: recording user trips (both manually and automatically via smartphone sensors ); calculating route scores based on community reports ; aggregating community data according to freshness and consensus ; and integrating external meteorological data. While anonymous users can browse public data, the full scope of data contribution, anomaly confirmation, and trip personalization is restricted to Registered Users.
...
\begin{center}
    \begin{longtable}{ |l|p{0.8\linewidth}| }
        ...
        \hline
        WP\cwp      & A User wants to find a cycling path between point A and point B.   \\
        \hline
        WP\cwp      & A User wants to view the details of a path (e.g., status, weather, elevation gain). \\
        \hline
        WP\cwp      & A Registered User wants to create a Trip by navigating on an existent path  \\
        \hline
        WP\cwp      & A Registered User wants to record a new path by cycling(automatic mode).   \\
        \hline
        WP\cwp      & A Registered User wants to plan a path “at the desk” by drawing it on the map (manual mode).   \\
        \hline
...
\hline
    ...
    \hline
    SP\csp  & The User rejects or corrects an incorrect automatic detection issue (e.g., pothole or obstacle).& User & BBP \\
    \hline
