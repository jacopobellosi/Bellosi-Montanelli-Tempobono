...
\hline
\stepcounter{reqcounter} \thereqcounter & BBP shall allow an RCY, during the save process (UC9, UC12), to specify: (1) The visibility of the \texttt{Path} (Public/Private for search), and (2) The visibility of the \texttt{Trip} (Public/Private for statistics aggregation). \\ % R37 (ex-R39)
\hline
