...
\begin{center}
    \begin{longtable}{|l|p{0.75\linewidth}|}
        ...
        \textbf{Actor}            & Registered User \\
        \hline
        \textbf{Entry conditions} & The user is registered, logged in, and is viewing the details of a \texttt{Path} (UC5). \\
        \hline
        ...
        \hline
        \textbf{Exit condition}   & The new \texttt{Status\_report} is saved. The \texttt{Path}'s score is updated. The user is returned to the \texttt{Path Details} screen. \\
        \hline
        \textbf{Exceptions}       & \begin{itemize}[noitemsep, nolistsep]
...
\begin{center}
    \begin{longtable}{|l|p{0.75\linewidth}|}
        ...
        \hline
        \textbf{Exit condition}   & The new \texttt{Obstacle\_report} is saved. The \texttt{Path}'s score may be updated. The user is returned to the \texttt{Path Details} screen. \\
        \hline
        \textbf{Exceptions}       & \begin{itemize}[noitemsep, nolistsep]
                                    \item The user cancels the submission. No report is created.
...
\begin{table}[h!]
    ...
    \begin{tabularx}{\textwidth}{|X|X|}
        ...
        \begin{itemize}
            \item [DA2] The device’s GPS sensor provides location data accurate enough to faithfully reconstruct the path taken.
            \item [DA12] The user, while cycling, will not change the track or get lost.
            \item [DA14] Paths refer to either dedicated bike tracks or roads with low traffic and cycling-compatible speeds.
        \end{itemize} 
        \\ \hline
    \end{tabularx}
\end{table}
...
\begin{table}[h!]
    ...
    \begin{tabularx}{\textwidth}{|X|X|}
        ...
        \begin{itemize}
            ...
            \item [R37] BBP shall allow RCY to submit Status_reports manually for paths.
            \item [R38] BBP shall allow RCY to submit Obstacle_reports manually for paths.
