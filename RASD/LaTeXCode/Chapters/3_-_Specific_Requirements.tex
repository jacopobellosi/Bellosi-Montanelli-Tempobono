...
\begin{center}
    \begin{longtable}{|l|p{0.75\linewidth}|}
        ...
        \textbf{Event Flow}       & 1 - The User navigates to their profile and taps the "My Trips" option. \\
                                  ...
                                  & 3 - The Server retrieves all \texttt{Trip} objects associated with that user (R32). \\
                                  ...
                                  & 8 - The Server retrieves the full \texttt{Trip} object, including its \texttt{GPS\_points}, \texttt{Statistic}, \texttt{Weather\_info}, and any associated \texttt{Obstacle\_report}s (R33). \\
...
\begin{center}
    \begin{longtable}{|l|p{0.75\linewidth}|}
        ...
        \textbf{Event Flow}       & 1 - The User taps the "Report status" button. \\
                                  ...
                                  & 4 - BBP Application sends the new \texttt{Status\_report} to the Server, associated with the current \texttt{Path}. \\
                                  & 5 - The Server saves the new \texttt{Status\_report}. \\
                                  & 6 - The Server triggers a recalculation of the \texttt{Path}'s `derivedStatus` and `derivedScore` (R8, R9). \\
        \hline
...
\begin{center}
    \begin{longtable}{|l|p{0.75\linewidth}|}
        ...
        \textbf{Event Flow}       
                                  ...
                                  & 6 - The Server may trigger a recalculation of the \texttt{Path}'s `derivedScore` (R10), as obstacles affect the score. \\
        \hline
