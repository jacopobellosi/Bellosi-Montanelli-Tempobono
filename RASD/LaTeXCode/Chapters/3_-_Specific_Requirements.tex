...
\begin{table}[h!]
    ...
    \begin{tabularx}{\textwidth}{|X|X|}
        \hline
        \begin{itemize}
            \item [R7] The system allows users to search for public cycling paths.
            \item [R9] The system calculates and displays the aggregated status of paths.
...
\begin{table}[h!]
    ...
    \begin{tabularx}{\textwidth}{|X|X|}
        ...
        \begin{itemize}
            ...
            \item [R25] BBP shall allow an RCY to stop the automatic trip recording.
            \item [R26] Upon stopping recording, if sensor\_events were logged, BBP shall present them to the user for review.
            \item [R27] BBP shall allow the user to confirm or ignore each sensor\_event during review.
            \item [R28] BBP shall create an Obstacle\_report associated with the trip only for confirmed sensor\_events.
            \item [R29] After recording (and review), BBP shall calculate final trip statistics.
            \item [R30] After recording, BBP shall retrieve and associate weather information with the trip.
            \item [R31] BBP shall allow the user to save the completed Trip (path, stats, weather, confirmed reports) to their private archive.
        \end{itemize}
        &
        \begin{itemize}
...
\begin{table}[h!]
    ...
    \begin{tabularx}{\textwidth}{|X|X|}
        \hline
        \begin{itemize}
            \item [R29] After recording, the system associates weather data with the trip.
            \item[R30] After recording, the system retrieves and associates weather information with the trip.
            \item[R31] The system allows the user to save the completed Trip (path, stats, weather, confirmed reports) to their private archive.
        \end{itemize} 
        & 
        \begin{itemize}
            \item [DA11] The external weather service API is available, stable, and provides accurate data.
...
\begin{table}[h!]
    ...
    \begin{tabularx}{\textwidth}{|X|X|}
        ...
        \begin{itemize}
            ...
            \item [R39] BBP shall allow an RCY to specify the visibility (Public/Private) when saving a trip or manually created path.
