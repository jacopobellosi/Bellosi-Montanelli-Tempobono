...
\begin{table}[h!]
    ...
    \begin{tabularx}{\textwidth}{|X|X|}
        \hline
        \begin{itemize}
            \item [R14] The system retrieves and displays current weather data for the selected path.
            \item [R15] The system allows users to start navigation for a selected path.
        \end{itemize} 
        & 
        \begin{itemize}
            \item [D12] The user, while cycling, will not change the track or get lost.
            \item [D14] Paths refer to either dedicated bike tracks or roads with low traffic and cycling-compatible speeds.
        \end{itemize} 
        \\ \hline
    \end{tabularx}
\end{table}
