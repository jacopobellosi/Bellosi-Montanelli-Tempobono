...
\begin{table}[h!]
    ...
    \begin{tabularx}{\textwidth}{|X|X|}
        ...
        & 
        \begin{itemize}
            \item [D3] Accelerometer and gyroscope data correlate with real-world physical events (e.g., potholes, vibrations).
            \item [D4] A data threshold exists to reliably distinguish significant movements (potholes) from normal biking vibrations.
        \end{itemize} 
        \\ \hline
    \end{tabularx}
\end{table}
