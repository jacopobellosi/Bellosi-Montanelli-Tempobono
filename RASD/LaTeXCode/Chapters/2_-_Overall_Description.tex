...
\begin{center} 
    \begin{longtable}{@{}|p{0.19\linewidth}|p{0.81\linewidth}|@{}}
       \hline
        ...
        \hline
        \textbf{Preconditions} & User logged in; understands options (\hyperref[da:17]{DA17}). \\
        \hline
        \textbf{Description} & From her profile, Anna selects “Create Manual Path.” She draws the Path on the map, names it “Tuesday Ride,” activates “Make Public,” and presses “Save” (\hyperref[da:17]{DA17}). The Path becomes available to others. \\
      \hline
...
\begin{center}
    \begin{longtable}{@{}|p{0.19\linewidth}|p{0.81\linewidth}|@{}}
        ...
        \hline
        \textbf{Description} & Carlo presses “Start Recording.” The app tracks his movement, displaying real-time data. While riding, a strong shock occurs due to a pothole. Sensors send data spikes to BBP. Upon completion, BBP asks for confirmation (\hyperref[da:9]{DA9}); Carlo validates correct detections and saves the trip. The app displays weather data (\hyperref[da:11]{DA11}) and summary before saving (\hyperref[da:12]{DA12}). \\
        \hline
...
\begin{center}
    \begin{longtable}{@{}|p{0.19\linewidth}|p{0.81\linewidth}|@{}}
       \hline
        ...
        \hline
        \textbf{Description} & Carlo’s recording continues, but the detected spike results from jumping off a curb. After terminating the recording, when asked to confirm detections, Carlo (acting in good faith, (\hyperref[da:9]{DA9})) presses “No, ignore” for incorrect ones. The BBP system cancels invalid detections, and Carlo completes the trip as in Scenario 3.2. \\
        \hline
...
\begin{center}
    \begin{longtable}{@{}|p{0.19\linewidth}|p{0.81\linewidth}|@{}}
        ...
        \hline
        \textbf{Description} & Carlo rides on a smooth Path. No anomalies are detected. When pressing “End and Save,” BBP skips the “Review” step and directly shows the summary screen. \\
        \hline
...
\paragraph{Automatic Path Creation.}
