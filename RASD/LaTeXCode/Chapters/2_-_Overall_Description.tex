...
\begin{figure}[H]
    \begin{center}
        \includegraphics[width=1\linewidth]{UML_Class_Diagram.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{RASD/images/state}
    \caption{State Diagram for the \texttt{Trip} (UC7) lifecycle.}
    \label{fig:sd_trip}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{images/SD_SensorEvent.png}
    \caption{State Diagram for the \texttt{sensor\_event} (UC8) lifecycle.}
