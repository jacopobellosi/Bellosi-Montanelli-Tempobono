...
\begin{center} 
    \begin{longtable}{@{}|p{0.19\linewidth}|p{0.81\linewidth}|@{}}
        ...
        \hline
        \textbf{Description} & Marco presses “Follow Route”, The app loads the route on an External navigation app. This app guides him along the route. Ultimately, Marcom returns to BBP, offering him the data of the trip and offers to register Marco so he can save his ride information. \\
        \hline
...
After a route has been selected from the search results, the User taps "Follow Route". The BBP system then loads the chosen route onto the External navigation service and begins acquiring GPS data to provide stats data based on the user's current position (GPS assumed to be available per DA2).
...
\textbf{Follow Route (Navigation):} The User taps “Follow Route”; BBP redirect to an External navigation service and use GPS to acquire travel data. At the end, BBP show the summary of the trip and offer registration to save the data.\\
