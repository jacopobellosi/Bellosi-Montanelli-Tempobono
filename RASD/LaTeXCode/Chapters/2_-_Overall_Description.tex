...
\textbf{Manual path dreation:} The User opens the editor, draws the path, optionally adds maintenance pins, sets type and visibility, and presses “Save.”\\
\textbf{Publish/Privacy Choice:} When saving a manually created path, the User can make it Public (visible to everyone) or keep it Private in their library.\\
