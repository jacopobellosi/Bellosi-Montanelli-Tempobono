...
\begin{center} 
    \begin{longtable}{@{}|p{0.19\linewidth}|p{0.81\linewidth}|@{}}
        ...
        \hline
        \textbf{Description} & Marco presses “Follow Path”, The app loads the Path on an External navigation app. This app guides him along the Path. Ultimately, Marcom returns to BBP, offering him the data of the trip and offers to register Marco so he can save his ride information. \\
        \hline
...
\begin{center} 
    \begin{longtable}{@{}|p{0.19\linewidth}|p{0.81\linewidth}|@{}}
       \hline
        ...
        \hline
        \textbf{Description} & From her profile, Anna selects “Create Manual Path.” She draws the Path on the map, names it “Tuesday Ride,” places maintenance pins, activates “Make Public,” and presses “Save” (\hyperref[da:2]{DA2}). The Path becomes available to others. \\
      \hline
