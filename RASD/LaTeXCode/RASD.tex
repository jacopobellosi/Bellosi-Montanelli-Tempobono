...
\usepackage[hidelinks]{hyperref}  % To allow linked reference within the document
...
\begin{document}
    ...
    \puttitle{
        ...
        name1= Bellosi Jacopo - 10806471, % Author Name and Surname
        name2= Montanelli Matteo - 10829541,
        name3= Manuel Tempobono - 10789942,
